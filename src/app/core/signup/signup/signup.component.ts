...
export class SignupComponent implements OnInit, OnDestroy {
          ...
          this.message = [
            {
              severity: 'success',
              summary: 'Sucesso',
              detail: `Foi enviado um e-mail de confirmação para o endereço de email ${response.data.email}.`,
            },
          ];
          this.status = true;
        }
            ...
            this.message = [
              {
                severity: 'warn',
                summary: 'Alerta',
                detail: `Você já se cadastrou com o e-mail ${values.email}, verifique seu e-mail para ativar sua conta!`,
              },
            ];
            ...
            this.message = [
              {
                severity: 'warn',
                summary: 'Alerta',
                detail: `Já existe uma conta ativa com o e-mail ${values.email} cadastrado!`,
              },
            ];
          }
        } else {
          this.message = [
            {
              severity: 'error',
              summary: 'Erro',
              detail: `Erro ao cadastrar e-mail, tente novamente mais tarde`,
            },
          ];
        }
      }
          ...
          this.message = [
            {
              severity: 'success',
              summary: 'Sucesso',
              detail: `Foi enviado um e-mail de confirmação para o endereço de email ${
  ...
  submitSocial(): void {
    ...
    this.unsubSocial = this.authService.authState.subscribe((user) => {
      if (user) {
        this.signupService.queueSocial(user).subscribe(
          (response) => {
              ...
              this.message = [
                {
                  severity: 'warn',
                  summary: 'Alerta',
                  detail: `Já existe uma conta ativa com o esse usuário Google!`,
                },
              ];
            } else {
              this.message = [
